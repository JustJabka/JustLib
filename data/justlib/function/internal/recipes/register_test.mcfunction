...
data modify storage justlib:recipes recipes append value {id:"minecraft:diamond",count:4}
data modify storage justlib:recipes recipes append value {id:"minecraft:diamond",count:5}