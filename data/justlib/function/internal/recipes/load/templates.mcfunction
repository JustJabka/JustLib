...
data modify storage justlib:recipes template set value [\
    {Slot:0b,components:{"minecraft:custom_data":{"dynamic":"function justlib:internal/recipes/action/scroll","scroll_amount":-1},"minecraft:item_model":"justlib:gui/move_up"}},\
    {Slot:9b,components:{"!minecraft:item_model":{}}},\
    {Slot:18b,components:{"minecraft:custom_data":{"dynamic":"function justlib:internal/recipes/action/scroll","scroll_amount":1},"minecraft:item_model":"justlib:gui/move_down"}},\
]
