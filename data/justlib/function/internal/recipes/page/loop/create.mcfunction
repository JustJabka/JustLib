# Add empty page
data modify storage justlib:recipes pages append from storage justlib:recipes page_template
...
scoreboard players remove #pages main 100
execute if score #pages main matches 1.. run function justlib:internal/recipes/page/loop/create