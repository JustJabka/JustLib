...
execute store result storage justlib:main health.need_to_heal int -1 run scoreboard players operation #need_to_heal justlib.health -= #heal_result justlib.health