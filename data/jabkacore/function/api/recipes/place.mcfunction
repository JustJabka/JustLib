...
execute align xyz run summon minecraft:item_display ~0.5 ~0.5 ~0.5 {\
    ...
    item:{id:"minecraft:poisonous_potato",count:1,components:{"minecraft:item_model":"jabkacore:crafting_table","minecraft:custom_data":{"jabkacore.block.loot_table":"jabkacore:blocks/crafting_table"}}},\
